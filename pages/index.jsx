              ...
              <div className="my-12 text-center md:text-left md:my-0 md:w-1/2">
                ...
                <div className="flex items-center justify-center md:justify-start">
                  ...
                  <a
                    ...
                    href="https://twitter.com/intent/tweet?text=Tailwind Starter Kit - A library of components made with Tailwind CSS to bootstrap your projects&via=uvacoder&url=https://uva-tailwind-starter-kit.vercel.app"
                    target="_blank">
